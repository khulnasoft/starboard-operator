...
import (
	...
	"github.com/khulnasoft/starboard-operator/pkg/controller/job"
	"github.com/khulnasoft/starboard-operator/pkg/controller/pod"

	"sigs.k8s.io/controller-runtime/pkg/log/zap"

	"github.com/khulnasoft/starboard-operator/pkg/logs"
	"k8s.io/client-go/kubernetes"
	"sigs.k8s.io/controller-runtime/pkg/cache"
	"sigs.k8s.io/controller-runtime/pkg/manager"

	"github.com/khulnasoft/starboard-operator/pkg/khulnasoft"

	"github.com/khulnasoft/starboard-operator/pkg/scanner"
	"github.com/khulnasoft/starboard-operator/pkg/trivy"

	appsv1 "k8s.io/api/apps/v1"

	"github.com/khulnasoft/starboard-operator/pkg/reports"

	"github.com/khulnasoft/starboard-operator/pkg/etc"
	starboardv1alpha1 "github.com/khulnasoft/starboard/pkg/apis/khulnasoft/v1alpha1"
...
func getEnabledScanner(config etc.Config) (scanner.VulnerabilityScanner, error) {
	if config.ScannerTrivy.Enabled && config.ScannerKhulnasoftCSP.Enabled {
	...
	if config.ScannerKhulnasoftCSP.Enabled {
		setupLog.Info("Using Khulnasoft CSP as vulnerability scanner", "version", config.ScannerKhulnasoftCSP.Version)
		return khulnasoft.NewScanner(versionInfo, config.ScannerKhulnasoftCSP), nil
	}
