...
type Config struct {
	Operator       Operator
	ScannerKhulnasoftCSP ScannerKhulnasoftCSP
...
type ScannerTrivy struct {
	...
	ImageRef string `env:"OPERATOR_SCANNER_TRIVY_IMAGE" envDefault:"khulnasoft/trivy:0.11.0"`
}

type ScannerKhulnasoftCSP struct {
	Enabled  bool   `env:"OPERATOR_SCANNER_KHULNASOFT_CSP_ENABLED" envDefault:"false"`
	Version  string `env:"OPERATOR_SCANNER_KHULNASOFT_CSP_VERSION" envDefault:"5.0"`
	ImageRef string `env:"OPERATOR_SCANNER_KHULNASOFT_CSP_IMAGE" envDefault:"khulnasoft/scanner:5.0"`
	Host     string `env:"OPERATOR_SCANNER_KHULNASOFT_CSP_HOST"`
	Username string `env:"OPERATOR_SCANNER_KHULNASOFT_CSP_USERNAME"`
	Password string `env:"OPERATOR_SCANNER_KHULNASOFT_CSP_PASSWORD"`
}
